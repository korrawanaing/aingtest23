...
mysql_select_db($database_mysqli, $mysqli);
$query_insert1 = "SELECT * FROM aing_admin";
$insert1 = mysql_query($query_insert1, $mysqli) or die(mysql_error());
$row_insert1 = mysql_fetch_assoc($insert1);
$totalRows_insert1 = mysql_num_rows($insert1);
?>
